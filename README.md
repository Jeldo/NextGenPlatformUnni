...
**산출 근거:** 강남언니 누적 상담 신청 670만 건 중 시술 카테고리 70%(약 470만 건)가 주기성 시술. 푸시 도달율 55% 기준, 주기 리마인드 도달 시 업계 개인화 알림 전환율(10~15%) 적용. 비침습 시술 특성상 "시기를 놓쳐서 미루는" 패턴이 재예약 지연의 주요 원인이며, 리마인드가 이 병목을 직접 해소.
