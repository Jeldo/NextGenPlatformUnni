...
일반적인 AIDLC 활용과 차별화된 점은 **Application Design 단계에서 각 기능 요구사항에 대한 컴포넌트 동작을 세세하게 설계**한 것입니다.
...
이렇게 각 FR에 대해 컴포넌트 간 호출 흐름, 에러 처리, 상태 전이를 모두 명시하여 **코드 생성 시 AI가 설계 의도를 정확히 반영**할 수 있도록 했습니다.
