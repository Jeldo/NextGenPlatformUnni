...
- Name: calendar.spec.ts >> 시술 상세 페이지 >> 구글 캘린더 등록 버튼이 표시된다
- Location: e2e/calendar.spec.ts:85:7
...
Locator: getByLabel('구글 캘린더에 등록하기')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByLabel('구글 캘린더에 등록하기')
